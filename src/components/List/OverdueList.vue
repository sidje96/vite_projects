...
<template>
    ...
    <v-list-item v-bind="props" title="Achterstallig onderhoud" class="text-custom-color"></v-list-item>
    </template>
    ...
    <v-row no-gutters class="w-100">
        ...
        <span v-if="!item.Pictures || item.Pictures.length === 0">No pictures</span>
        <span v-else>
